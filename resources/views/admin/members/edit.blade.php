...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/members">العضويات</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
...
@method('PUT')
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" placeholder="اسم العضوية" class="form-control" value="{{$member->title}}" />
                                                @if ($errors->has('title'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="point" placeholder="عدد النقاط" class="form-control" value="{{$member->point}}" />
                                                @if ($errors->has('point'))
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="type" placeholder=" الترتيب" class="form-control" value="{{$member->type}}" />
                                                @if ($errors->has('type'))
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="main" value="1" {{$member->main == '1' ? 'checked':''}}>
                                                <span>نعم</span>
                                                <input type="radio" name="main" value="0" {{$member->main == '0' ? 'checked':''}}>
                                                <span>لا</span>
                                                @error('main')
