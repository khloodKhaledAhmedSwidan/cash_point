...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/contacts')}}">تواصل معنا</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <h1 class="page-title">عرض الرسائل
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($contacts as $contact)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    @if (App\User::find($contact->user_id)->type == '2')
                                        متجر
                                    @elseif (App\User::find($contact->user_id)->type == '1')
                                    عميل
                                    @endif
                                    </td>
                                <td>
...
$country = App\User::find($contact->user_id)->country_id;
$code = App\Models\Country::find($country)->code;

        $phone = $code .\App\User::find($contact->user_id)->phone;
                            @endphp
                                ...
                                <td>
                                                ...
                                                <a class="delete_user btn btn-danger" data="{{ $contact->id }}" data_name="{{ App\User::find($contact->user_id)->name }}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_user', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/contact";
