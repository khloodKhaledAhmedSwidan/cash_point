...
@section('title')
ارسال اشعارات لفئة من المستخدمين
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/general-notifications')}}">  ارسال اشعارات لفئة من المستخدمين
    ...
    <h1 class="page-title">  ارسال اشعارات لفئة من المستخدمين
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <select name="category"
                                                                        ...
                                                                        <option value="2">المتاجر
                                                                        </option>
                                                                        <option value="1">العملاء
                                                                        </option>
