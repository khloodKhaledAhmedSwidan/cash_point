...
@section('title')
ارسال اشعارات لمستخدمي التطبيق
@endsection
...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/general-notifications')}}">   ارسال اشعارات لمستخدمي التطبيق
                </a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <h1 class="page-title">   ارسال اشعارات لمستخدمي التطبيق

        <small>ارسال اشعار</small>
    </h1>
@endsection
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">ارسال اشعار</span>
                                </div>
                                            ...
                                            <div class="portlet light bordered table-responsive">
                                                    ...
                                                    <div class="form-horizontal" role="form">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">المستخدمين</label>
                                                                <div class="col-md-9">
                                                                    <select name="user_id[]"
                                               ...
                                               <strong style="color: red;">{{ $errors->first('title') }}</strong>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea  name="description" class="form-control" placeholder="محتوي  الاشعار' " value="{{old('description')}}"></textarea>
