...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/uncomfirm-bank-replacementpoint')}}">طلبات الاستبدال غير مؤكده</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>طلبات الاستبدال غير مؤكده </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">طلبات الاستبدال غير مؤكده
        <small>عرض جميع طلبات الاستبدال غير مؤكده</small>
    </h1>
@endsection
