...
@method('PUT')
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" placeholder="اسم الدولة" class="form-control" value="{{$country->name}}" />
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="code" placeholder="كود الدولة" class="form-control" value="{{$country->code}}" />
                                                @if ($errors->has('code'))
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="currency" placeholder="العملة " class="form-control" value="{{$country->currency}}" />
