...
@section('page_header')
    ...
    <h1 class="page-title">عرض الاسلايدر
        <small>عرض جميع الاسلايدر</small>
    </h1>
@endsection
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($sliders as $slider)
                            <tr class="odd gradeX">
                                ...
                                <td> <img src="{{asset('uploads/sliders/'.$slider->image)}}" style=" border-radius: 50%; width:15%; "> </td>
                                <td>  
                                    @if($slider->link)
                                    <a href="{{$slider->link}}">
                                    <i class="fa fa-eye"></i>
                                    ...
                                    @else 
                                    <i class="fa fa-eye-slash"></i>                                         @endif
                        </td>
                                <td>{{$slider->user_id != null ?App\User::find($slider->user_id)->name:'' }} </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a class="delete_user" data="{{ $slider->id }}" data_name="" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_user', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/slider";
