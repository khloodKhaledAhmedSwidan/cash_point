                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form role="form" action="/admin/update/user/{{$user->id}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="school_name" placeholder="أسم المدرسة" class="form-control" value="{{$user->school_name}}" />
                                                @if ($errors->has('school_name'))
                                                    <span class="help-block">
                                                       <strong style="color: red;">{{ $errors->first('school_name') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label"> ملاحظات </label>
                                                <input type="text" name="notes" placeholder="  ملاحظات" class="form-control" value="{{$user->notes}}" />
                                                @if ($errors->has('notes'))
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="gender" placeholder=""   value="0" @if($user->gender == '0') checked @endif /> أنثي
                                                <input type="radio" name="gender" placeholder=""   value="1" @if($user->gender == '1') checked @endif /> ذكر
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="subscription" placeholder=""   value="0" @if($user->subscription == '0') checked @endif /> مجاني
                                                <input type="radio" name="subscription" placeholder=""   value="1" @if($user->subscription == '1') checked @endif /> مدفوع
                                                @if ($errors->has('subscription'))
                                                    <span class="help-block">
                                                       <strong style="color: red;">{{ $errors->first('subscription') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                            ...
                                            <div class="form-body">
                                                <div class="form-group ">
                                                    <label class="control-label col-md-3">  الصوره الشخصية</label>
                                                    <div class="col-md-9">
