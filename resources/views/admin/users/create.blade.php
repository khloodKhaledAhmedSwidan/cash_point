                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="school_name" placeholder="أسم المدرسة" class="form-control" value="{{old('school_name')}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="notes" placeholder="  ملاحظات" class="form-control" value="{{old('notes')}}" />
                                                @if ($errors->has('notes'))
                                                    <span class="help-block">
