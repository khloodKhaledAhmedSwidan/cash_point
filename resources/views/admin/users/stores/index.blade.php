...
@section('page_header')
    ...
    <h1 class="page-title">عرض المتاجر
        <small>عرض جميع المتاجر</small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                <a class="btn sbold green" href="/admin/add/store"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($users as $user)
                            <tr class="odd gradeX">
                                ...
                                <td><?php echo ++$i ?></td>
                                <td> {{$user->name}} </td>
                                <td> <img src="{{asset('uploads/users/'.$user->logo)}}" style=" border-radius: 50%; width:15%; " /></td>
                                <td>
                                  {{$user->category->name}}
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            {{--</li>--}}
                                            <li>
                                                <a href="/admin/edit/store/{{$user->id}}">
