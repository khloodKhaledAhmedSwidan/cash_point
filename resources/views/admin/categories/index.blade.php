                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($categories as $category)
                            <tr class="odd gradeX">
                                ...
                                <td><?php echo ++$i ?></td>
                                <td> {{$category->name}} </td>
                                <td> <img src="{{asset('uploads/categories/'.$category->image)}}" style=" border-radius: 50%; width:15%; "> </td>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_user', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/category";
